const PAGES = {
  ...
  inbound: {
    ...
    columns: [
      ...
      { key: 'warehouseCode', label: '仓库' },
      { key: 'putawayStatus', label: '状态', badge: true },
      { key: 'trackingNo', label: '跟踪号/货柜号', mono: true, empty: '—' },
      { key: 'receiveTime', label: '收货完成时间', empty: '未收货' },
      { key: 'putawayTime', label: '上架完成时间', empty: '未上架' },
      { key: 'createTime', label: '创建时间' },
    ],
  },
  warehouses: {
...
const STATUS_BADGE_CLASS = {
  '已出库': 'ok', '已发货': 'ok', '已入库': 'ok', '已上架': 'ok', '已收货': 'ok',
  '待出库': 'pending', '待收货': 'pending', '部分上架': 'pending', '新建': 'pending',
  '待入库': 'pending', '待审核': 'pending', '已取面单': 'pending',
  '在途': 'transit', '收货中': 'transit', '仓库处理中': 'transit',
  '已取消': 'cancelled', '异常': 'cancelled', '驳回': 'cancelled',
};
